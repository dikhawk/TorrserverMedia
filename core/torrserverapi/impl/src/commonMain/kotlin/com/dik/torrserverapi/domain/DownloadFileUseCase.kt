...
internal class DownloadFileUseCase(
    ...
    operator fun invoke(
        ...
        Logger.Companion.i("$tag Started download file from $fileUrl to $outputFilePath")
        ...
        return flow {
            ...
            Logger.Companion.i("$tag Successfully download file from $fileUrl to $outputFilePath")
